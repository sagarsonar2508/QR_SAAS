...
export const DOCS: DocPage[] = [
  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Go to **Billing**, pick a plan and pay. In India you can pay by UPI Autopay, card or netbanking (processed by Razorpay); everywhere else, payment is handled by PayPal and prices are shown in US dollars. Monthly and annual billing are available — annual saves roughly two months. Your new quota applies immediately.",
      },
